...
namespace Synapse.Controls.Answer_Key
{
    public partial class AnswerKeyFieldControl : UserControl
    {
        ...
        private CheckBoxAdv GenerateOptionUI(string name, Size size)
        {
            ...
            option.CheckedImage = Properties.Resources.CustomCheckBox_Checked;
            option.UncheckedImage = Properties.Resources.CustomCheckBox_Unchecked;
            option.MouseOverCheckedImage = Properties.Resources.CustomCheckBox_Checked_MouseOver;
            option.MouseOverUncheckedImage = Properties.Resources.CustomCheckBox_Unchecked_MouseOver;
