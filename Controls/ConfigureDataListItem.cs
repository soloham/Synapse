...
namespace Synapse.Controls
{
    public partial class ConfigureDataListItem : UserControl
    {
        ...
        private Bitmap omrConfigIcon = Properties.Resources.Text_Braille_WF;
        ...
        private Bitmap obrConfigIcon = Properties.Resources.QR_Code___02;
        ...
        private Bitmap icrConfigIcon = Properties.Resources.Quill_WF;
        #endregion
        #region Main
        [Description("Gets or Sets the Main Configuration Type."), Category("Main Options")]
        internal MainConfigType ConfigType { get { return configType;  } set { configType = value; SetConfigType(value); } }
        ...
        internal static ConfigureDataListItem Create(ConfigurationBase configBase)
        {
